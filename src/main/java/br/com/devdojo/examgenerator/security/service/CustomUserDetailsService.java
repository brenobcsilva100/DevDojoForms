...
public class CustomUserDetailsService implements UserDetailsService {
    ...
    private final static class CustomUserDetails extends ApplicationUser implements UserDetails{
        ...
        public Collection<? extends GrantedAuthority> getAuthorities() {
            List<GrantedAuthority> authrityListProfessor = AuthorityUtils.createAuthorityList("ROLE_PROFESSOR");
            List<GrantedAuthority> authrityListStudent = AuthorityUtils.createAuthorityList("ROLE_STUDENT");
            return this.getProfessor() != null ? authrityListProfessor : authrityListStudent;
        }
